...
export async function processAndMapEvents(storage: IStorage): Promise<void> {
  try {
    ...
    // NOTE: The Sportybet direct injection code has been removed as requested.
    // Events will now be processed solely through the main event mapping logic
    // This may result in fewer Sportybet-only events in the database.
